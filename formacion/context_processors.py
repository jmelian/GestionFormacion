...
def global_context(request):
    ...
    if user.is_authenticated:
        ...
        context['es_rrhh'] = 'RRHH' in grupos_usuario
        context['es_formacion'] = 'Formación' in grupos_usuario
        context['es_direccion'] = 'Dirección' in grupos_usuario
        context['es_empleado'] = 'Empleado' in grupos_usuario # Si tienes un grupo base para todos los empleados
